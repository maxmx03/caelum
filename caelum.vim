...
call Hl('MatchParen', { 'fg': 'brown', 'bold': s:true })
...
call Hl('Conditional', { 'fg': 'brown' })
call Hl('Repeat', { 'fg': 'brown' })
call Hl('Label', { 'fg': 'brown' })
call Hl('Operator', { 'fg': 'brown' })
call Hl('Statement', { 'fg': 'brown' })
call Hl('Keyword', { 'fg': 'brown', })
call Hl('Exception', { 'fg': 'brown' })
call Hl('PreProc', { 'fg': 'brown' })
call Hl('Define', { 'fg': 'brown' })
call Hl('Macro', { 'fg': 'brown' })
call Hl('PreCondit', { 'fg': 'brown' })
call Hl('Type', { 'fg': 'blue' })
call Hl('StorageClass', { 'fg': 'brown' })
call Hl('Structure', { 'fg': 'brown' })
call Hl('Typedef', { 'fg': 'brown' })
call Hl('Special', { 'fg': 'purple' })
call Hl('SpecialChar', { 'fg': 'purple' })
call Hl('Tag', { 'fg': 'orange', 'bold': s:true })
call Hl('Delimiter', { 'fg': 'brown' })
